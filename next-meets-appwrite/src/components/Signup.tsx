...
const Signup = () => {
  ...
  // api appwrite part here we are declaring the type of event instead of saying it any for Better deployement purposes as its typeScript
  const create = async (evt: FormEvent<HTMLFormElement>) => {
    evt.preventDefault();
    try {
